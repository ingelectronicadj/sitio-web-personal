    ...
    es: {
        ...
        awards: {
            ...
            prize: [
                ...
                '<i class="fa-li fa fa-trophy text-warning"></i> Especialista en servidores y protocolos de red IPv6 - Hurricane Electrics Certification - 2018',
                '<i class="fa-li fa fa-trophy text-warning"></i> 1 <sup>rd</sup> Lugar - Hackathon Reinventa Realiza y Respira - Universidad Javeriana - Proyecto Diaspora: Calidad del aire con IoT LPWAN - 2018',
                '<i class="fa-li fa fa-trophy text-warning"></i> 1 <sup>st</sup> Lugar - IA Experience Antioquia - Proyecto RIU: Reacción inmediata en salas de urgencias con IoT e inteligencia artificial para triage - 2017</li>',
                '<i class="fa-li fa fa-trophy text-warning"></i> 1 <sup>rd</sup> Lugar - Regional Santander Digital - Gobernación de Santander - Videoreproductor con lengua de señas Assersum - 2017',
                '<i class="fa-li fa fa-trophy text-warning"></i> 1 <sup>st</sup> Lugar - Hackathon Bunny Inc - Proyecto RF 433MHz para control de invernaderos - 2016',
                '<i class="fa-li fa fa-trophy text-warning"></i> 2 <sup>nd</sup> Lugar - Eco-Hackathon - Botanical Garden of Bogotá - Proyecto GSM/GPRS para estaciones meteorológicas- 2015',
                '<i class="fa-li fa fa-trophy text-warning"></i> 1 <sup>st</sup> Lugar - Hackathon for peace and free culture - Alta Consejería Distrital of TIC - Anand Seeds AgroEthernet - 2014'
            ]
        }
    ...
    en: {
        ...
        awards: {
            ...
            prize: [
                ...
                '<i class = "fa-li fa fa-trophy text-warning"> </i> Sage on servers and IPv6 networks - Hurricane Electrics Certification - 2018',
                '<i class = "fa-li fa fa-trophy text-warning"> </i> 1 <sup> rd </sup> Place - Hackathon Reinventa Realiza y Respira - University Javeriana - Diaspora: quality of the air with IoT LPWAN - 2018 ',
                '<i class = "fa-li fa fa-trophy text-warning"> </i> 1 <sup> st </sup> Place - IA Experience Antioquia - RIU: Immediate reaction in emergency rooms with IoT and artificial intelligence - 2017 </li> ',
                '<i class = "fa-li fa fa-trophy text-warning"> </i> 1 <sup> rd </sup> Place - Regional Santander Digital - Gobernación de Santander - Videoreproductor of sign language Assersum - 2017',
                '<i class = "fa-li fa fa-trophy text-warning"> </i> 1 <sup> st </sup> Place - Hackathon Bunny Inc - Anand Seeds Hack Agro-IoT whit RF 433MHz - 2016',
                '<i class = "fa-li fa fa-trophy text-warning"> </i> 2 <sup> nd </sup> Place - Eco-Hackathon - Botanical Garden of Bogotá - Weather stations with GSM / GPRS - 2015 ',
                '<i class = "fa-li fa fa-trophy text-warning"> </i> 1 <sup> st </sup> Place - Hackathon for peace and free culture - High District Council of ICT - Anand Seeds AgroEthernet - 2014'
            ]
        }
    }
}
