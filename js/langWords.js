...
// Ingeniero electrónico, especialista en gestión de proyectos, con más de 7 años de experiencia en el desarrollo de productos digitales accesibles (Software y Hardware). Encargado de diseñar y desarrollar soluciones tecnológicas efectivas y accesibles para garantizar que la innovación beneficie a todas las personas, sin importar sus capacidades.

// Experiencia
// Gestor Tecnopedagógico
// Universidad Nacional Abierta y a Distancia - UNAD
// Certificación laboral por 4 años y 6 meses.Funciones: Aportar en el desarrollo de ambientes virtuales de aprendizaje, auditar recursos educativos digitales en accesibilidad web y desarrollar software para la automatización de procesos.Algunos proyectos de gran impacto:
// Lideré el proceso de actualización tecnológica de la Universidad en el año 2020, desarrollé todas las vistas de aulas modelo para la oferta de cursos de las distintas facultades y logré automatizar varios procesos para que los docentes pudieran crear cursos con estándares de calidad aportando a la NTC6576 - Norma Técnica Colombiana para el Diseño y Oferta de Cursos en Ambientes Virtuales de Aprendizaje.
